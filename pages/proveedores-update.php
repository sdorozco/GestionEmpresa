...
session_start();
    ...
    if($_GET != null){
        $proveedor = $crudProveedor->obtenerProveedor($_GET['id']);
    }
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-truck zmdi-hc-fw"></i> Proveedores</h1>
			</div>
		...
		<div class="container-fluid">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form action="../controller/adminProveedores.php" method="post">
				    	<fieldset>
				    		...
				    		<div class="container-fluid">
                                ...
                                <div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<input pattern="[0-9+]{1,15}" class="form-control" type="text" name="codigo_proveedor" maxlength="15" required="true" autocomplete="off"
                                              value="<?php echo $proveedor->getCodigo_proveedor() ?>" readonly="readonly">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
										  	<label class="control-label">Nombre del proveedor *</label>
										  	<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="nombre" required="true" maxlength="30" autocomplete="off"
                                              onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $proveedor->getNombre() ?>">
										</div>
				    				</div>
				    				<div class="col-xs-12">
										<div class="form-group label-floating">
										  	<label class="control-label">Responsable de atención *</label>
										  	<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" class="form-control" type="text" name="responsable" required="true" maxlength="50" autocomplete="off"
                                              onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $proveedor->getResponsable() ?>">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	<label class="control-label">Teléfono</label>
										  	<input pattern="[0-9+]{1,15}" class="form-control" type="text" name="telefono" maxlength="15" autocomplete="off"
				    				...
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<input class="form-control" type="email" name="email" maxlength="50" required="true" autocomplete="off"
                                              value="<?php echo $proveedor->getEmail() ?>">
										</div>
				    				</div>
				    				<div class="col-xs-12">
										<div class="form-group label-floating">
										  	<label class="control-label">Dirección *</label>
										  	<input  name="direccion" class="form-control" maxlength="100" required="true" autocomplete="off"
                                              onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $proveedor->getDireccion() ?>"></input>
										</div>
				    				</div>
				    			</div>
				    		</div>
                        ...
                        <input type="hidden" value="actualizar" name="actualizar"></input>
