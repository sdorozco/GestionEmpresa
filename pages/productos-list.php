...
<body>
	...
	<section class="full-box dashboard-contentPage">
        ...
        <div class="container-fluid">
			...
			<p class="lead">Bienvenidos a la sección de productos, podras agregar nuevos productos y listar los productos registrados en la aplicación.</p>
		</div>
						...
						<table class="table table-hover text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="productos-update.php?id=<?php echo $producto->getCodigo_producto() ?>" class="btn btn-success btn-raised btn-xs">
											<i class="zmdi zmdi-refresh"></i>
										</a>
									</td>
									<td>
										<form>
											<a href="../controller/adminProducto.php?id=<?php echo $producto->getCodigo_producto() ?>&accion=e" type="submit" class="btn btn-danger btn-raised btn-xs">
