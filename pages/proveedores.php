			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form action="../controller/adminProveedores.php" method="post">
				    		...
				    		<div class="container-fluid">
                                ...
                                <div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<input pattern="[0-9+]{1,15}" class="form-control" type="number" name="codigo_proveedor" maxlength="15" required="true" autocomplete="off">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
                        ...
                        <input type="hidden" value="insertar" name="insertar"></input>
