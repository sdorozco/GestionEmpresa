<?php
    ...
    $Pedidoslist = $crudPedidos->mostrar();
...
<body>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu" >
				...
				<li id="administrar" style="display: block">
					...
					<ul class="list-unstyled full-box">
					    <li>
							<a href="Pedidos.php"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Pedidos</a>
						</li>
						<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Listado de las Pedidos registradas en la aplicación, podras actualizar, y eliminar la Pedidos.</p>
		</div>
			...
			<ul class="breadcrumb breadcrumb-tabs">
			  	<li>
			  		<a href="pedidos.php" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; NUEVOS PEDIDOS
			  		</a>
			  	</li>
			  	<li>
			  		<a href="pedidos-list.php" class="btn btn-success">
			  			<i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE PEDIDOS
			  		</a>
			  	</li>
			</ul>
		</div>
		<!-- panel lista de Pedidoss -->
		<div class="container-fluid">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-hover text-center">
							...
							<tbody>
                                <?php foreach($Pedidoslist as $Pedidos) { ?>
								<tr>
									<td><?php echo $Pedidos->getCodigo_Pedido() ?></td>
									<td><?php echo $Pedidos->getProveedor() ?></td>
									<td><?php echo $Pedidos->getEmail() ?></td>
                                    <td><?php echo $Pedidos->getCantidad() ?></td>
                                    <td><?php echo $Pedidos->getTotal() ?></td>
									<td>
										<a href="pedidos-update.php?id=<?php echo $Pedidos->getCodigo_Pedido() ?>" class="btn btn-success btn-raised btn-xs">
											<i class="zmdi zmdi-refresh"></i>
										</a>
									</td>
									<td>
										<form>
											<a href="../controller/adminPedidos.php?id=<?php echo $Pedidos->getCodigo_Pedido() ?>&accion=e" type="submit" class="btn btn-danger btn-raised btn-xs">
