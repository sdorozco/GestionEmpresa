						...
						<table class="table table-hover text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="categoria-update.php?id=<?php echo $categoria->getCodigo_categoria() ?>" class="btn btn-success btn-raised btn-xs">
											<i class="zmdi zmdi-refresh"></i>
										</a>
									</td>
									<td>
										<a href="../controller/adminCategoria.php?id=<?php echo $categoria->getCodigo_categoria() ?>&accion=e" class="btn btn-danger btn-raised btn-xs">
