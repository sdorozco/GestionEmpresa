...
session_start();
	...
	$total = $crudProductolist->total();
	$totalcantidad = $crudProductolist->totalcantidad();
...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Bienvenidos a la sección de Pedidos, podras crear tus pedidos desde aqui, consultar el listado de los pedidos generados y generar los reportes.</p>
		</div>
			...
			<div class="panel panel-info">
				...
				<div  class="row">
					...
					<div class="col-xs-12 col-sm-6" align="right">
						...
						<i> Código Pedido  # </i><?php echo $count ?>
					</label>
                     </div>
					</div>
				</div>
				...
				<form action="../controller/adminProductList.php" method="post">
				    		...
				    		<div class="container-fluid">
								...
								<input pattern="[0-9-]{1,30}" class="form-control" type="hidden" name="codigo_productolist" required="true" maxlength="30"
									...
									<div class="container-fluid">
										...
										<input type="hidden" name="insertarPedido" value="insertarPedido"></input>
										<ul class="breadcrumb breadcrumb-tabs">
			                        	 <li>
					...
					<div class="table-responsive" style="width: 100%">
						<table class="table table-striped table-hover" style="width: 100%">
							...
							{ if($productolist->getEstado() == "0" && $productolist->getCodigo_pedido() == $count){?>
								<tr>
									...
									<td>
										<p class="text-center">
											<a href="../controller/adminProductList.php?id=<?php echo $productolist->getCodigo_productolist()?>&accion=ep" class="btn btn-raised btn-danger btn-xs"><i class="zmdi zmdi-delete"></i></a>
										</p>
									</td>
								</tr>
							<?php }} ?>
				...
				<form action="../controller/adminPedidos.php" method="post">
				    	<fieldset>
				    		...
				    		<div class="container-fluid">
									...
									<div class="col-xs-12 col-sm-6">
									    <div class="form-group label-floating">
										  	...
										  	<select class="form-control" name="proveedor" id="nameproveedor" onClick="cargarProveedor(this);">
                                                <option value="@">Selecciona un Proveedor</option>
										  		<?php foreach ($proveedorlist as $proveedor){?>
									          	<option value="<?php echo $proveedor->getEmail() ?>"><?php echo $proveedor->getNombre() ?></option>
									          	<?php }?>
									        </select>
										</div>
									</div>
									<div class="col-xs-12  col-sm-6">
										<div class="form-group label-floating">
										  	...
										  	<input class="form-control" type="email" name="email" maxlength="50" onKeyUp="valor();" required="true" id="idemail" readonly="readonly" value="@">
										</div>
				    				</div>
									<div class="col-xs-12 col-sm-3">
                                       <div class="form-group label-floating">
							...
							<p class="text-center" style="margin-top: 20px;">
							    <input type="hidden" name="codigo_pedido" value="<?php echo $count ?>"></input>
