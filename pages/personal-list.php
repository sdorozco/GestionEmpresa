	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				Personal <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu" >
				...
				<li id="administrar" style="display: block">
					...
					<ul class="list-unstyled full-box">
					    <li>
							<a href="Personal.php"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Personal</a>
						</li>
						<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> PERSONAL</h1>
			</div>
			<p class="lead">Listado de los usuarios registrados en la aplicación, podras actualizar, eliminar y consultar a los usuarios que necesites.</p>
		</div>
			...
			<ul class="breadcrumb breadcrumb-tabs">
			  	<li>
			  		<a href="personal.php" class="btn btn-info">
			  			<i class="zmdi zmdi-plus"></i> &nbsp; NUEVA USUARIO
			  		</a>
			  	</li>
			  	<li>
						...
						<table class="table table-hover text-center">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="personal-update.php?id=<?php echo $Personal->getCodigo_Personal() ?>" class="btn btn-success btn-raised btn-xs">
											<i class="zmdi zmdi-refresh"></i>
										</a>
									</td>
									<td>
										<form>
											<a href="../controller/adminPersonal.php?id=<?php echo $Personal->getCodigo_Personal() ?>&accion=e" type="submit" class="btn btn-danger btn-raised btn-xs">
