<?php
	...
	$facturas = $crudFacturacion->mostrar();
?>
<!DOCTYPE html>
<html lang="es">
<head>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> REPORTES</h1>
			</div>
			<p class="lead">Listado de las facturas registradas en la aplicación, podras actualizar, eliminar y generar reportes pdf de las facturas.</p>
		</div>
		...
		<div class="container-fluid">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE REPORTES</h3>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-hover text-center">
							...
							<tbody>
                                <?php foreach($facturas as $facturacion) { ?>
								<tr>
									<td><?php echo $facturacion->getCodigo_factura() ?></td>
									<td><?php echo $facturacion->getCliente() ?></td>
									<td><?php echo $facturacion->getEmail() ?></td>
									<td><?php echo $facturacion->getCantidad() ?></td>
									<td><?php echo $facturacion->getTotal() ?></td>
									<td>
										<a href="facturacion-update.php?id=<?php echo $facturacion->getCodigo_factura() ?>" class="btn btn-success btn-raised btn-xs">
											<i class="zmdi zmdi-refresh"></i>
										</a>
									</td>
                                    <td>
										<a href="../controller/adminPdf.php?id=<?php echo $facturacion->getCodigo_factura() ?>" class="btn btn-warning btn-raised btn-xs">
											<i class="zmdi zmdi-file"></i>
										</a>
									</td>
									<td>
										<form>
											<a href="../controller/adminFactura.php?id=<?php echo $facturacion->getCodigo_factura() ?>&accion=e" type="submit" class="btn btn-danger btn-raised btn-xs">
