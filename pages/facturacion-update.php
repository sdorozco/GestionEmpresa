...
session_start();
	...
	if($_GET != null){
	$count = $crudFacturacion->obtenerfacturacion($_GET['id']);
	$total = $crudProductolist->totalFactura($_GET['id']);
	$totalcantidad = $crudProductolist->totalcantidadReporte($_GET['id']);
	}
	$count2 = $crudProductolist->count();
	$tipo_pagos = $crudTipoPago->mostrar();
	$idfactura = $count->getCodigo_factura();
				...
				<div  class="row">
					...
					<div class="col-xs-12 col-sm-6" align="right">
						<label class="panel-title">
							<i> Código Factura  # </i><?php echo $count->getCodigo_factura() ?>
					</label>
                     </div>
					</div>
				</div>
				...
				<form action="../controller/adminProductList.php" method="post">
				    		...
				    		<div class="container-fluid">
								...
								<input pattern="[0-9-]{1,30}" class="form-control" type="hidden" name="codigo_productolist" required="true" maxlength="30"
									...
									<input pattern="[0-9-]{1,30}" class="form-control" type="hidden" name="codigo_factura" required="true" maxlength="30"
                                        value="<?php echo $count->getCodigo_factura() ?>" readonly="readonly">
									...
									<div class="container-fluid">
										...
										<input type="hidden" name="insertarUpdate" value="insertarUpdate"></input>
										<ul class="breadcrumb breadcrumb-tabs">
			                        	 <li>
					...
					<div class="table-responsive" style="width: 100%">
						<table class="table table-striped table-hover" style="width: 100%">
							...
							{ if($productolist->getEstado() == "1" && $productolist->getCodigo_factura() == $count->getCodigo_factura()){?>
								<tr>
									...
									<td>
										<p class="text-center">
											<a href="../controller/adminProductList.php?id=<?php echo $productolist->getCodigo_productolist()?>&accion=efu&codigo=<?php echo $count->getCodigo_factura() ?>" class="btn btn-raised btn-danger btn-xs"><i class="zmdi zmdi-delete"></i></a>
										</p>
									</td>
								</tr>
							<?php }} ?>
				...
				<form action="../controller/adminFactura.php" method="post">
				    	<fieldset>
				    		...
				    		<div class="container-fluid">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
											  ...
											  value="<?php echo $count->getCliente() ?>" >
										</div>
				    				</div>
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
									...
									<div class="col-xs-12">
										<div class="form-group label-floating">
											  ...
											  value="<?php echo $count->getDireccion() ?>">
										</div>
				    				</div>
									<div class="col-xs-12 col-sm-3">
										<div class="form-group label-floating">
										  	<label class="control-label">Fecha *</label>
										  	<input class="form-control" type="text" name="fecha" maxlength="50" required="true"
											  value="<?php echo $count->getFecha() ?>" readonly="readonly">
										</div>
				    				</div>
									<div class="col-xs-12 col-sm-3">
                                       <div class="form-group label-floating">
										  	<label class="control-label" >Método de Pago</label>
											  <input class="form-control" type="text" name="modopago" maxlength="50" required="true"
											  value="<?php echo $count->getModopago() ?>" readonly="readonly">
										</div>
									</div>    
									<div class="col-xs-12 col-sm-3">
										<div class="form-group label-floating">
							...
							<p class="text-center" style="margin-top: 20px;">
							    <input type="hidden" name="codigo_factura" value="<?php echo $count->getCodigo_factura() ?>"></input>
