...
session_start();
    ...
    if($_GET != null){
    $empresa = $crudEmpresa->obtenerEmpresa($_GET['id']);
    }
?>
<!DOCTYPE html>
<html lang="es">
				    			...
				    			<div class="row">
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
                                              ...
                                              value="<?php echo $empresa->getCodigo_Empresa()?>" readonly="readonly">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
                                              ...
                                              onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $empresa->getNombre()?>">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	<label class="control-label">Teléfono</label>
										  	<input pattern="[0-9+]{1,15}" class="form-control" type="text" name="telefono" maxlength="15" value="<?php echo $empresa->getTelefono()?>">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	<label class="control-label">E-mail *</label>
										  	<input class="form-control" type="email" name="email" maxlength="50" required="true" value="<?php echo $empresa->getEmail()?>">
										</div>
				    				</div>
				    				<div class="col-xs-12">
										<div class="form-group label-floating">
                                              ...
                                              <input class="form-control" type="text" name="direccion" maxlength="170" requered="true"
                                               onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $empresa->getCodigo_Empresa()?>">
										</div>
				    				</div>
				    			</div>
				    		</div>
