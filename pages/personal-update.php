...
session_start();
    ...
    $login2 = $crud->obtenerUsuario($_GET['id']);
    $tipo_rolList = $crudTipo_rol->mostrar();
    $personal = $crudPersonal->obtenerPersonal($_GET['id']);
				    			...
				    			<div class="row">
				    				<div class="col-xs-12">
								    	<div class="form-group label-floating">
                                              ...
                                              value="<?php echo $personal->getCodigo_personal() ?>" readonly="readonly">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
								    	<div class="form-group label-floating">
                                              ...
                                              value="<?php echo $personal->getNombre() ?>">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
                                              ...
                                              value="<?php echo $personal->getApellido() ?>">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
                                              ...
                                              value="<?php echo $personal->getEmail() ?>">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
                                              ...
                                              value="<?php echo $personal->getTelefono() ?>">
										</div>
				    				</div>
				    				...
				    				<div class="col-xs-12">
										<div class="form-group label-floating">
										  	...
										  	<input name="direccion" class="form-control" rows="2" maxlength="100" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"
                                              value="<?php echo $personal->getDireccion() ?>"></input>
										</div>
									</div>
								</div>
							</div>
				    		...
				    		<div class="container-fluid">
				    				...
				    				<div class="col-xs-12">
							    		<div class="form-group label-floating">
											  ...
											  onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $login2->getUserName() ?>">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating" >
										  	<label class="control-label">Nueva Contraseña *</label>
										  	<input class="form-control" type="password" name="userpass" maxlength="70" >
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-6">
										<div class="form-group label-floating">
										  	<label class="control-label">Confirmar la contraseña *</label>
										  	<input class="form-control" type="password" name="pass_rep" maxlength="70">
										</div>
